...
public class Constants {
    ...
    public static final String RESPONSE_KEY_PHONEID = "phoneId";
    ...
    public static final int IQ_ABNORMAL = 1;
    public static final int IQ_NORMAL = 2;
    public static final String CO2_DEFAULT_VALUE = "1000";
    public static final String HCHO_DEFAULT_VALUE = "80";
    public static final String TVOC_DEFAULT_VALUE = "380";
    public static final String IQ_DEFAULT_VALUE = "60";
