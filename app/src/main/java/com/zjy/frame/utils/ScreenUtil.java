...
/**
 * Created by zhujunyu on 2018/3/20.
 */
...
//    }
     ...
     */
    public static Bitmap shotScrollView(ScrollView scrollView,Context context) {
        int h = 0;
        Bitmap bitmap = null;
        for (int i = 0; i < scrollView.getChildCount(); i++) {
            h += scrollView.getChildAt(i).getHeight();
            scrollView.getChildAt(i).setBackgroundColor(context.getResources().getColor(R.color.white));
        }
...
//        canvasNew.drawBitmap(bitmap, 0, 0, paint);
        for (int i = 0; i < scrollView.getChildCount(); i++) {
            scrollView.getChildAt(i).setBackgroundColor(context.getResources().getColor(R.color.transparent));
        }
    ...
    // 给图片添加水印
    public static Bitmap createBitmap(Context context,Bitmap src, String string,boolean isWhite) {
        ...
        if(isWhite){
            paint.setColor(context.getResources().getColor(R.color.text_color1));
        }else {
            paint.setColor(context.getResources().getColor(R.color.text_color1));
        }
